...
namespace SchoolWebRegister.Domain.Helpers
{
    public static class HashPasswordHelper
    {
        ...
        private static string GenerateIdentityV3Hash(string password, KeyDerivationPrf prf = KeyDerivationPrf.HMACSHA256, int iterationCount = 10000, int saltSize = 16)
        {
        ...
        private static bool VerifyIdentityV3Hash(string password, string passwordHash)
        {
        ...
        {
            return GenerateIdentityV3Hash(password);
        }
        public static bool VerifyPassword(ApplicationUser user, string password)
        {
            return VerifyIdentityV3Hash(password, user.PasswordHash);
        }
    }
}
